...
describe('DefsSolver - depth and edge cases', () => {
    ...
    it('detects circular references across multiple levels', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Circular config definition reference'
        )
    })
    ...
    it('throws when a deep reference points to an unknown definition', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Unknown config definition pointer "#/$defs/missing"'
        )
    })
    ...
    it('throws when $defs is not an object', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Invalid config definitions at /$defs in configuration: expected an object'
        )
    })
    ...
    it('throws when $ref is not a string', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Invalid config reference at /config in configuration: "$ref" must be a string'
        )
    })
    ...
    it('throws when a local override is provided on a non-object reference', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Invalid config reference at /config in configuration: "#/$defs/port" must resolve to an object when local overrides are provided'
        )
    })
    ...
    it('throws when a definition pointer has no definition name', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Invalid config definition pointer "#/$defs" at /config in configuration: expected a definition name'
        )
    })
    ...
    it('throws when a JSON pointer escape is invalid', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Invalid JSON pointer escape in "#/$defs/a~2b" at /config in configuration'
        )
    })
    ...
    it('throws when a nested pointer segment is unknown', () => {
        ...
        expect(() => new DefsSolver().solve(document)).toThrow(
            'Unknown config definition pointer "#/$defs/item/missing" at /config in configuration'
        )
    })
})
